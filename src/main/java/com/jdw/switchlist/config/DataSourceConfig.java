...
import com.jdw.switchlist.SwitchlistApplication;
...
{
    private static final Logger logger = LoggerFactory.getLogger(SwitchlistApplication.class);
    ...
    public DataSource dataSource()
    {
        ...
        if (dbValue.equalsIgnoreCase("POSTGRESQL"))
        {
            ...
            String dbname = System.getenv("MYDBNAME") != null ? System.getenv("MYDBNAME") : "switchlist";
